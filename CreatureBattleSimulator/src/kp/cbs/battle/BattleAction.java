...
public abstract class BattleAction implements Comparable<BattleAction>
{
    ...
    public static final BattleAction catchAction(ItemId item) { return new CatchAction(item); }
    ...
    public ItemId getItem() { throw new UnsupportedOperationException(); }
    ...
    private static final class CatchAction extends BattleAction
    {
        private final ItemId item;
        
        private CatchAction(ItemId item)
        {
            this.item = Objects.requireNonNull(item);
        }
        
        @Override
        public final ItemId getItem() { return item; }
        
        @Override
        public final BattleActionType getType() { return BattleActionType.CATCH; }
